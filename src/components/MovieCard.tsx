...
export default function MovieCard({ movie, variant = 'poster', showRank, isNew }: MovieCardProps) {
  ...
  return (
    <Link
      ...
      style={{
        transition: 'transform 400ms cubic-bezier(0.25, 0.46, 0.45, 0.94), z-index 0ms 300ms',
    ...
    >
      ...
      >
        <div className="flex gap-2 mb-3">
          <button className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center hover:bg-opacity-90 transition-colors">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              <path d="M8 5v14l11-7z" />
            </svg>
          </button>
          <button className="w-8 h-8 rounded-full bg-[#2a2a2a] text-white flex items-center justify-center hover:bg-[#333333] transition-colors border border-[#404040]">
          ...
          <button className="w-8 h-8 rounded-full bg-[#2a2a2a] text-white flex items-center justify-center hover:bg-[#333333] transition-colors border border-[#404040] ml-auto">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
